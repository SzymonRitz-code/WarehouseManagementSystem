...
- [ADR-002: Transactional outbox](ADR-002-transactional-outbox.md)
- [ADR-003: Domain events vs integration events](ADR-003-domain-events-vs-integration-events.md)
