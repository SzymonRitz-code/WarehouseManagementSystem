...
{
    public static object Product(Product product)
    {
        return new
        {
            product.Id,
    ...
    public static object ProductBatch(ProductBatch batch)
    {
        return new
        {
            batch.Id,
    ...
    public static object Warehouse(Warehouse warehouse)
    {
        return new
        {
            warehouse.Id,
    ...
    public static object WarehouseZone(WarehouseZone zone)
    {
        return new
        {
            zone.Id,
    ...
    public static object Stock(Stock stock)
    {
        return new
        {
            stock.Id,
    ...
    public static object StockReservation(StockReservation reservation)
    {
        return new
        {
            reservation.Id,
    ...
    public static object Document(Document document)
    {
        return new
        {
            document.Id,
    ...
    public static object DocumentItem(DocumentItem item)
    {
        return new
        {
            item.Id,
